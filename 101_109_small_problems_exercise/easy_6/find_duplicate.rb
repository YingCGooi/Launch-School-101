...
# return value: the value in which is duplicated twice in the array
# side note: only one value occurs twice in the original array

# iterate through the array
# select the duplicated element
# return a new array containing that duplicated element
